...
public class OdometryGlobalCoordinatePosition implements Runnable{
    ...
    private void globalCoordinatePositionUpdate(){
        ...
        verticalLeftEncoderWheelPosition = (DriveTrain.getLeftPosition() * verticalLeftEncoderPositionMultiplier);
        verticalRightEncoderWheelPosition = (DriveTrain.getRightPosition() * verticalRightEncoderPositionMultiplier);
        ...
        normalEncoderWheelPosition = (DriveTrain.getMiddlePosition()*normalEncoderPositionMultiplier);
